...
import Step1Scene from './App/Step1Scene';

// import BankSearch from './App/BankSearch';

import screens from './App/screens';


function defundDaplApp() {
  // return (
  //   <BankSearch />
  // );
      ...
      renderScene={(route, navigator) => {
        ...
        switch (route.screen) {
          case screens.LOOKUP:
            nextScene = (
              <BankCheckScene
                ...
                onBankProvided={(bankName) => {
                  navigator.push({
                    title: 'Bank lookup results',
          ...
          case screens.STEP1:
            ...
            break;
          default:
            nextScene = (<View><Text>How did we get here??</Text></View>);
        }
        return nextScene;
      }}
    />
...
//     title: 'Bank Lookup Results',
//     screen: screens.REPORT,
//     bankName: 'Boeing Employees Credit Union',
//   });
// }}
// )


AppRegistry.registerComponent('defundDAPL', () => defundDaplApp);
...
// AppRegistry.registerComponent('defundDAPL', () => TestShare);
